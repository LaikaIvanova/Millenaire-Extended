...
public class ItemBookFrankSigmarOne extends Item implements IHasModel {
	public ItemBookFrankSigmarOne(String name) {
    ...
    {
            tooltip.add(I18n.format("book.franksigmarbook1.text1"));
            tooltip.add(I18n.format("book.franksigmarbook1.text2"));
			tooltip.add(I18n.format("book.franksigmarbook1.text3"));
    }
